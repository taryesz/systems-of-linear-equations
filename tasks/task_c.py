...
from plot import plot_residual_norm_changes
...
solution, iterations, residual_norm_vector_jacobi, time_to_find_solution = solve_using_jacobi(system_matrix, system_matrix_size, excitation_vector)
...
solution, iterations, residual_norm_vector_gauss_seidel, time_to_find_solution = solve_using_gauss_seidel(system_matrix, system_matrix_size, excitation_vector)
...
plot_residual_norm_changes([residual_norm_vector_jacobi, residual_norm_vector_gauss_seidel], ['Jacobi', 'Gauss-Seidel'])
